import { Vector2D, Wire, Junction, NetLabel, PowerPort } from '@opencad/core';
...
export class WireRenderer {
  private static readonly WIRE_COLOR = '#008800';
  private static readonly WIRE_SELECTED_COLOR = '#0088ff';
  private static readonly WIRE_WIDTH = 2;
  private static readonly JUNCTION_RADIUS = 4;
  private static readonly JUNCTION_COLOR = '#008800';
  private static readonly LABEL_COLOR = '#009988';
  private static readonly LABEL_SELECTED_COLOR = '#0088ff';
  private static readonly POWER_COLOR = '#cc0000';
  ...
  renderNetLabel(
    ...
    const labelText = (label as any).text ?? (label as any).name ?? '';
