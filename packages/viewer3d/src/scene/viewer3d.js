...
import { PCBRaycaster } from '../raycasting/pcb-raycaster';
export class PCB3DViewer {
    ...
    fitToBoard() {
        ...
        this.controls.target.copy(center);
        this.camera.position.set(center.x + distance * 0.5, center.y - distance * 0.7, center.z + distance * 0.6);
        this.camera.up.set(0, 0, 1);
